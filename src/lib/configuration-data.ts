...
export const processCatalog: ProcessCatalogItem[] = [
  ...
  { id: "P-35", name: "Sistemas de Gestión de Calidad", level: "process", sourceLabel: "Sistemas de Gestión de Calidad", representation: "Círculo de inicio", status: "Borrador", scope: "Por definir" },
  ...
  { id: "P-11", name: "Recursos Humanos", level: "process", sourceLabel: "Recursos Humanos", representation: "Círculo de inicio", status: "Borrador", scope: "Por definir" },
  ...
  { id: "P-18", name: "Laboratorio", level: "subprocess", parentId: "P-17", sourceLabel: "Laboratorio", representation: "Círculo de manufactura", status: "Borrador", scope: "Por definir" },
  ...
  { id: "P-23", name: "Corte de Bata", level: "subprocess", parentId: "P-22", sourceLabel: "Corte de Bata", representation: "Círculo de manufactura", status: "Borrador", scope: "Por definir" },
  { id: "P-24", name: "Confección de Bata", level: "subprocess", parentId: "P-22", sourceLabel: "Confección de Bata", representation: "Círculo de manufactura", status: "Borrador", scope: "Por definir" },
