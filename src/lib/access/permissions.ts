...
const definitions: Array<[string, PermissionRiskLevel, string]> = [
  ...
  ["documents.edit", "MEDIUM", "Editar metadata documental"],
  ["documents.version", "HIGH", "Crear nuevas versiones documentales"],
  ["documents.obsolete", "HIGH", "Declarar documentos obsoletos"],
  ["documents.delete", "CRITICAL", "Eliminar documentos lógicamente"],
  ["documents.restore", "CRITICAL", "Restaurar documentos eliminados"],
  ["documents.history", "HIGH", "Consultar historial documental"],
  ["documents.master_list", "LOW", "Consultar Lista Maestra"],
