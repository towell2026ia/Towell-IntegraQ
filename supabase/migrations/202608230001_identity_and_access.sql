...
insert into public.processes (id, name, level, parent_id) values
  ...
  ('P-35', 'Sistemas de Gestión de Calidad', 'process', null),
  ('P-09', 'Almacén', 'process', null),
  ('P-10', 'Compras', 'process', null),
  ('P-11', 'Recursos Humanos', 'process', null),
...
insert into public.position_process_permissions (position_id, process_id, relationship, document_role) values
  ('PU-01', 'P-03', 'owner', 'modifier'), ('PU-01', 'P-04', 'approver', 'authorizer'), ('PU-01', 'P-08', 'approver', 'authorizer'), ('PU-01', 'P-35', 'approver', 'authorizer'),
  ...
  ('PU-07', 'P-08', 'owner', 'modifier'), ('PU-07', 'P-35', 'owner', 'modifier'), ('PU-07', 'P-33', 'support', 'viewer'),
  ...
  ('PU-16', 'P-08', 'participant', 'viewer'), ('PU-16', 'P-35', 'participant', 'viewer'), ('PU-16', 'P-13', 'support', 'viewer'), ('PU-16', 'P-17', 'support', 'viewer'), ('PU-16', 'P-22', 'support', 'viewer'), ('PU-16', 'P-33', 'support', 'viewer'),
